...
from draganddrop.models import Filemodel, UploadManage, ApprovalLog, PDFfilemodel, Downloadtable, DownloadFiletable, Address, Group, UrlUploadManage, UrlDownloadtable, UrlDownloadFiletable, OTPUploadManage, OTPDownloadtable, OTPDownloadFiletable, ResourceManagement, PersonalResourceManagement
    ...
    def get_context_data(self, **kwargs):
        ...
        # 使用しない場合 承認済みのApprovalManageを作成
            ...
            if first_approvers:
                ...
                # 申請ステータスを「一次承認済み」に設定
                url_upload_manage.application_status = 3
                url_upload_manage.save()
                ...
                for first_approver in first_approvers:
                    ...
                    approval_log = ApprovalLog.objects.create(
                        ...
                        approval_operation_user_position = 1, # 一次承認者
                        approval_operation_user_company_id = self.request.user.company.id,
                        approval_operation_date =  url_upload_manage.created_date,
                        approval_operation_content = 2, # 一次承認
                        manage_id = url_upload_manage.pk
                    )
                    approval_log.save()
            ...
            if second_approvers:
                ...
                # 申請ステータスを「最終承認済み」に設定
                url_upload_manage.application_status = 5
                url_upload_manage.save()
    ...
    def get_context_data(self, **kwargs):
        ...
        # 使用しない場合 承認済みのApprovalManageを作成
            ...
            if first_approvers:
                ...
                # 申請ステータスを「一次承認済み」に設定
                otp_upload_manage.application_status = 3
                otp_upload_manage.save()
                ...
                for first_approver in first_approvers:
                    ...
                    approval_log = ApprovalLog.objects.create(
                        ...
                        approval_operation_user_position = 1, # 一次承認者
                        approval_operation_user_company_id = self.request.user.company.id,
                        approval_operation_date =  otp_upload_manage.created_date,
                        approval_operation_content = 2, # 一次承認
                        manage_id = otp_upload_manage.pk
                    )
                    approval_log.save()
            ...
            if second_approvers:
                ...
                # 申請ステータスを「最終承認済み」に設定
                otp_upload_manage.application_status = 5
                otp_upload_manage.save()
